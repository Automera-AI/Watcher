...
| | What | Why it matters |
|---|---|---|
| 1 | **Arabic names for the treatments and branches** — the review page sent separately, and the three questions in it | Until these are in the workbook, "عايزة أحجز فاشيال في المعادي" reaches no treatment and no branch, and Nada asks a question that cannot be answered |
