...
story.append(Spacer(1, 10))
story.append(Paragraph(
    "<b>Totals:</b> ~14 engineering days remaining (0.1 and 0.4 are done). At six days a week that is a demo in about two weeks "
...
story.extend(section(
    ...
    [
        ("0.1", "Set default branch to <font name='Courier'>main</font> <font color='#1e8449'><b>[DONE]</b></font>",
         "NOW", "Trivial", "1 min",
        ...
        ("0.4", "Merge the eval branch <font color='#1e8449'><b>[DONE]</b></font>",
         "NOW", "Trivial", "0.25",
